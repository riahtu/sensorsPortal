...
define(['ojs/ojcore', 'knockout', 'jquery', 'config', 'util/dataload', 'data/data', 'moment', 'xlsOut',
     ...
     */
    function totEnerRepContentViewModel() {
        var self = this;
        ...
        self.getURL = function () {
            ...
            var urlParams = config.url + "nilm/appenergy?";
        ...
        self.downloadFile = function () {
            xlsOut(self.dataObservableArray(), 'Appliance_Energy');
        };
        ...
        self.loadChartData = function () {
            ...
            self.dataObservableArray().forEach(function (item) {
                ...
                tempArr.push({x: item.toTs, y: item.appEnergy});
    ...
    return totEnerRepContentViewModel;
});
