...
//             rootViewModel.applassetID
            ...
            jsonData.fetchData(self.url).
                    then(function (result) {
                        ...
                        result.forEach(function (item) {
                            ...
                            self.csTempData().push({name: item.name, temp: tempVal, time: timeVal, css: css, applid: item.applId});
                        });
        ...
        self.loadApplChart = function (data) {
            rootViewModel.applassetID(data.applid);
            oj.Router.rootInstance.go('csapplprof');
        };
        ...
        self.loadColdStrDB = function () {
            oj.Router.rootInstance.go('csappltemp');
        };
